...
https://developers.barocert.com/reference/pass/python/login/api#VerifyLogin
"""
...
try :
    obj = passcertService.verifyLogin(clientCode, '02309080230700000140000000000020', loginVerify)
    print(obj.receiptID)
    print(obj.state)
