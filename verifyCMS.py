...
https://developers.barocert.com/reference/pass/python/cms/api#VerifyCMS
"""
...
try :
    obj = passcertService.verifyCMS(clientCode, '02309080230700000140000000000016', cmsVerify)
    print(obj.receiptID)
    print(obj.state)
