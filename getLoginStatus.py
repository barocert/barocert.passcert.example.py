...
https://developers.barocert.com/reference/pass/python/login/api#GetLoginStatus
"""
...
try :
    obj = passcertService.getLoginStatus(clientCode, '02309080230700000140000000000020')
